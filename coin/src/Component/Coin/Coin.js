...
export default function Coin() {
    ...
    return (
        ...
        <div className="header">
            <ul className="nav">
                <li className="nav-item fomos-span"><svg className="fomos-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><defs></defs><path className="fomos-icon" d="M76.587,79.311a4.954,4.954,0,0,0-4.834,4.046A5.048,5.048,0,0,0,74.7,88.982a4.875,4.875,0,0,0,5.984-1.851,5.1,5.1,0,0,0-.613-6.347A4.847,4.847,0,0,0,76.587,79.311Zm0,8.226a3.107,3.107,0,0,1-2.4-1.143h2.4a.686.686,0,0,0,0-1.371H73.523a3.264,3.264,0,0,1,0-1.371h3.063a.686.686,0,0,0,0-1.371h-2.4a3.107,3.107,0,0,1,2.4-1.142,3.2,3.2,0,0,1,0,6.4Zm9.019.531-.825-9.085a.913.913,0,0,0-.518-.746l-8.127-3.814a.881.881,0,0,0-.892.084l-7.3,5.272a.921.921,0,0,0-.375.83l.152,1.673H66.282a.686.686,0,0,0,0,1.371h1.562l.125,1.371H66.282a.686.686,0,0,0,0,1.371h1.811l.3,3.3a.913.913,0,0,0,.519.746l8.126,3.814a.881.881,0,0,0,.892-.084l7.3-5.272A.921.921,0,0,0,85.606,88.067Zm-8.289,4.305L70.13,89l-.73-8.034L75.856,76.3l7.188,3.373.73,8.035Z" transform="translate(-65.61 -74.338)"/></svg><span className="fomos-des">Formos CryptoHub</span></li>
            ...
            <div className="user-wrap">
                <span><svg className="user-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><defs></defs><path className="user-icon" d="M577-1558a10,10,0,0,1,10-10,10,10,0,0,1,10,10,10,10,0,0,1-10,10A10,10,0,0,1,577-1558Zm16.835,5.462a8.75,8.75,0,0,0,1.05-9.254A8.75,8.75,0,0,0,587-1566.75a8.751,8.751,0,0,0-7.885,4.957,8.752,8.752,0,0,0,1.05,9.255c.888-1.43,2.842-2.962,6.835-2.962S592.947-1553.969,593.835-1552.538ZM583.25-1560.5a3.75,3.75,0,0,1,3.75-3.75,3.75,3.75,0,0,1,3.75,3.75,3.75,3.75,0,0,1-3.75,3.751A3.75,3.75,0,0,1,583.25-1560.5Z" transform="translate(-577 1568)"/></svg></span>
                ...
                <div className="body-watching">
                    ...
                    <div className="watch-list">
                        {lists.length > 0 && lists.map((list,index) =>(
                            ...
                            <p className="watching-item-description">{list.show_symbol}</p>
                            <p className="watching-item-price">{list.price}</p>
                            <p ref = {(element) => {
                            coinChange.current[index] = element;
            }}  className="watching-item-change">{list.delta_24h}%</p>
                        </div>
                                ))}
                    </div>
                </div>
                <div className="body-infomation">
                    ...
                    <div className="profile-content">
                        <div className="profile-heading">
                            ...
                            className="img-input" type="text" placeholder="Choose File" />
                            <label
                            className="browse-img-button" htmlFor = "getFile">Browse</label>
                        </div>
                        <div className="profile-body">
                            <div className="profile-item">
                            <label htmlFor="" className="profile-infomation" >First Name</label>
                            <input type="text" className="profile-input" placeholder="First Name..."/>
                            </div>
                            <div className="profile-item">
                            <label htmlFor="" className="profile-infomation" >Last Name</label>
                            <input type="text" className="profile-input" placeholder="Last Name..."/>
                            </div>
                            <div className="profile-item">
                            <label htmlFor="" className="profile-infomation">Email Address</label>
                            <input type="text" className="profile-input" placeholder="you@example.com"/>
                            </div>
                            <div className="profile-item">
                            <label htmlFor="" className="profile-infomation">Date of Birth</label>
                            <input type="text" className="profile-input" placeholder="MM/DD/YYYY"/>
                            </div>
                        </div>
                    </div>
